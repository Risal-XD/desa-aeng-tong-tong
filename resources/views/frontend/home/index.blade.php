...
@section('content')
    {{-- Hero --}}
    <section class="relative flex min-h-[85vh] items-center overflow-hidden bg-primary text-on-primary">
        ...
        <div class="relative mx-auto grid w-full max-w-6xl items-center gap-10 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:py-24">
            <div>
