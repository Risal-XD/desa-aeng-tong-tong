        ...
        <div class="relative mx-auto grid max-w-6xl items-center gap-10 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:py-24">
            <div>
                ...
                <div class="min-h-[5rem] sm:min-h-[7rem]" data-parallax-speed="30">
                    <h1 x-data="typewriter('Selamat Datang di\nDesa Aeng Tong-Tong', 100, 0)" class="font-display text-[1.75rem] font-semibold uppercase leading-snug text-white sm:text-[2.6rem] whitespace-pre-line" x-text="displayText"></h1>
                </div>
