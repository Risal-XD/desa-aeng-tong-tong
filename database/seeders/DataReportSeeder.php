    ...
    private function seedStatistics(Village $village): void
    {
        $groups = [
            [
                ...
                'rows' => [
                    ['label' => 'Laki-laki', 'value' => 4250, 'unit' => 'jiwa'],
                    ['label' => 'Perempuan', 'value' => 4385, 'unit' => 'jiwa'],
                    ['label' => 'Kepala Keluarga', 'value' => 2310, 'unit' => 'KK'],
                    ['label' => 'Usia 0–14', 'value' => 1830, 'unit' => 'jiwa'],
                    ['label' => 'Usia 15–64', 'value' => 5880, 'unit' => 'jiwa'],
                    ['label' => 'Usia 65+', 'value' => 925, 'unit' => 'jiwa'],
                ],
            ],
            [
